...
#'
#' @param Afill list(Ares, X), i.e., SPLR format
#' @param Ares SP format, with elements $i, $j, $v, $nrow, $ncol
#' @param X LR format, with elements $u, $d, $v. X$v is in BlockTT format.
