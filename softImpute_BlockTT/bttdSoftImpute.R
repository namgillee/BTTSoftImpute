...
{
  #Input
  # rank_Y     : rank of the estimated low rank matrix, X. 
  # ttrank_max : maximal TT rank of right singular vectors, X$v.
  # Y          : a sparse matrix format with attributes
  #                Y$i, Y$j, Y$v, Y$nrow, Y$ncol, Y$dimnames, 
  #              each of which are [nnz]-vector, [nnz x N]-matrix, 
  #              [nnz]-vector, scalar, N-vector, and list.
  #
  #Output
